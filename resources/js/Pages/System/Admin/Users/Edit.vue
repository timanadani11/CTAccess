...
<template>
  <SystemLayout>
    ...
    <template #header>
      <h2 class="text-xl font-semibold leading-tight text-gray-800">Editar Usuario #{{ props.user.id }}</h2>
    </template>
    ...
    <form class="space-y-6" @submit.prevent="submit">
      <div class="grid gap-4 sm:grid-cols-2">
        ...
        <div>
          <label class="block text-sm font-medium text-slate-700">Contraseña (opcional)</label>
